...
public class TalksListAcitivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		map.put(ITEM_TITLE, getString(R.string.talk_title1));
		map.put(ITEM_SYNOP, getString(R.string.talk_synop1));
		fillMaps.add(map);
		
		map = new HashMap<String, String>();
		map.put(ITEM_TITLE, getString(R.string.talk_title2));
		map.put(ITEM_SYNOP, getString(R.string.talk_synop2));
		fillMaps.add(map);
		
		map = new HashMap<String, String>();
		map.put(ITEM_TITLE, getString(R.string.talk_title3));
		map.put(ITEM_SYNOP, getString(R.string.talk_synop3));
		fillMaps.add(map);
		
		map = new HashMap<String, String>();
		map.put(ITEM_TITLE, getString(R.string.talk_title4));
		map.put(ITEM_SYNOP, getString(R.string.talk_synop4));
		fillMaps.add(map);
		
		map = new HashMap<String, String>();
		map.put(ITEM_TITLE, getString(R.string.talk_title5));
		map.put(ITEM_SYNOP, getString(R.string.talk_synop5));
		fillMaps.add(map);
		
		map = new HashMap<String, String>();
		map.put(ITEM_TITLE, getString(R.string.talk_title6));
		map.put(ITEM_SYNOP, getString(R.string.talk_synop6));
		fillMaps.add(map);
